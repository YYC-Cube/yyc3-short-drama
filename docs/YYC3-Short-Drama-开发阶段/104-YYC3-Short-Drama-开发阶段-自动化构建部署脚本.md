---
@file: 104-YYC3-Short-Drama-开发阶段-自动化构建部署脚本.md
@description: YYC3-Short-Drama 前端、后端的自动化构建、打包、部署脚本与规范
...
# 104-YYC3-Short-Drama-开发阶段-自动化构建部署脚本

## 概述

本文档详细描述YYC3-Short-Drama-开发阶段-自动化构建部署脚本相关内容，确保项目按照YYC³标准规范进行开发和实施。
