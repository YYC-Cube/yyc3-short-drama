---
@file: 070-YYC3-Short-Drama-API文档-第三方-短信邮件服务接口.md
@description: YYC3-Short-Drama 对接短信、邮件平台的接口规范与调用实现，包含验证码、通知等
...
# 070-YYC3-Short-Drama-API文档-第三方-短信邮件服务接口

## 概述

本文档详细描述YYC3-Short-Drama-API文档-第三方-短信邮件服务接口相关内容，确保项目按照YYC³标准规范进行开发和实施。
