---
@file: 062-YYC3-Short-Drama-API文档-业务域-文化资源接口手册.md
@description: YYC3-Short-Drama 文化资源管理相关接口的详细定义，包含资源上传、审核、发布等
...
# 062-YYC3-Short-Drama-API文档-业务域-文化资源接口手册

## 概述

本文档详细描述YYC3-Short-Drama-API文档-业务域-文化资源接口手册相关内容，确保项目按照YYC³标准规范进行开发和实施。
